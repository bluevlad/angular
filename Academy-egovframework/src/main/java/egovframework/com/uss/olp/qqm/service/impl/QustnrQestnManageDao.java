...
public class QustnrQestnManageDao extends EgovComAbstractDAO {
	...
	public List<?> selectQustnrManageStatistics2(Map<?, ?> map) throws Exception{
		return list("SurveyBank.selectQustnrManageStatistics2", map);
	}
	...
	public List<?> selectQustnrManageStatistics(Map<?, ?> map) throws Exception{
		return list("SurveyBank.selectQustnrManageStatistics", map);
	}
	...
	public Map<?, ?> selectQustnrManageQestnrSj(Map<?, ?> map) throws Exception{
		return (Map<?, ?>)selectOne("SurveyBank.selectQustnrManageQestnrSj", map);
	}
	...
	public List<?> selectQustnrQestnManageList(ComDefaultVO searchVO) throws Exception{
		return list("SurveyBank.selectQustnrQestnManage", searchVO);
	}
	...
	public List<?> selectQustnrQestnManageDetail(SurveyBankVO SurveyBankVO) throws Exception{
		return list("SurveyBank.selectQustnrQestnManageDetail", SurveyBankVO);
	}
	...
	public int selectQustnrQestnManageListCnt(ComDefaultVO searchVO) throws Exception{
		return (Integer)selectOne("SurveyBank.selectQustnrQestnManageCnt", searchVO);
	}
	...
	public void insertQustnrQestnManage(SurveyBankVO SurveyBankVO) throws Exception{
		insert("SurveyBank.insertQustnrQestnManage", SurveyBankVO);
	}
	...
	public void updateQustnrQestnManage(SurveyBankVO SurveyBankVO) throws Exception{
		insert("SurveyBank.updateQustnrQestnManage", SurveyBankVO);
	}
	...
	public void deleteQustnrQestnManage(SurveyBankVO SurveyBankVO) throws Exception{
		...
		//설문조사(설문결과) 삭제
		delete("SurveyBank.deleteQustnrRespondInfo", SurveyBankVO);
		//설문항목 삭제
		delete("SurveyBank.deleteQustnrItemManage", SurveyBankVO);

		//설문문항
		delete("SurveyBank.deleteQustnrQestnManage", SurveyBankVO);
	}
}
