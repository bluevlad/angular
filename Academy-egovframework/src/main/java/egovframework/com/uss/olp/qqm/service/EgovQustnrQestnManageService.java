...
public interface EgovQustnrQestnManageService {
	 ...
	 * @throws Exception
	 */
	void  insertQustnrQestnManage(SurveyBankVO SurveyBankVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	void  updateQustnrQestnManage(SurveyBankVO SurveyBankVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	void  deleteQustnrQestnManage(SurveyBankVO SurveyBankVO) throws Exception;
