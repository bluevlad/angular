...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/academy/exam/set/QueListPopup.do'/>";
...
function fn_search(){
	...
	vFrom.action = "<c:url value='/academy/exam/set/QueListPopup.do' />";
	vFrom.submit();
}
/* ********************************************************
 * 선택 처리 함수
...
function fn_add_Que(qestnrId){
	...
	vFrom.action = "<c:url value='/academy/exam/set/queInsert.do' />";
...
<form name="ListForm" action="" method="post" onSubmit="fn_search(); return false;">
	...
	<tr>
		...
		<th><spring:message code="exam.queType" /></th><!-- 질문유형 -->
		<th><spring:message code="exam.queCount" /></th><!-- 문항수 -->
		<th>*</th><!-- 선택  -->
	</tr>
	</thead>
	<tbody class="ov">	
