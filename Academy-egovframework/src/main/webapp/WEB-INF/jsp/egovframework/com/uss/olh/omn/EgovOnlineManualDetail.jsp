...
function fn_egov_list_OnlineManual(){
	location.href = "<c:url value='/uss/olh/omn/selectOnlineManualList.do'/>";
}
</script>
</head>
...
<tr>
	<td>
		<form name="formList" action="<c:url value='/uss/olh/omn/selectOnlineManualList.do'/>" method="post">
