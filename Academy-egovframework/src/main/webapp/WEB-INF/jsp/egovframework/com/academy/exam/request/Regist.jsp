...
function fnUpdate() {
    var varFrom = document.getElementById("ExamVO");
    varFrom.action = "<c:url value='/academy/exam/request/Insert.do'/>";
...
<body>
<form:form commandName="ExamVO" method="post" action="${pageContext.request.contextPath}/academy/exam/request/Insert.do' />" onSubmit="fnUpdate(); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<table class="wTable" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
		...
		<input type="hidden" name="examIp" value="<%=userIP%>" />
		<!-- 시험코드 -->
