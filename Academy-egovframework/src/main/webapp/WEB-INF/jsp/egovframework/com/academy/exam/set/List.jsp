...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/academy/exam/set/List.do'/>";
 ...
 ******************************************************** */
function fn_regist(){
	location.href = "<c:url value='/academy/exam/set/Regist.do' />";
}
/* ********************************************************
 * 검색 함수
 ******************************************************** */
function fn_search(){
	...
	vFrom.action = "<c:url value='/academy/exam/set/List.do' />";
	vFrom.submit();
...
<form name="listForm" action="<c:url value='/academy/exam/set/List.do'/>" method="post" onSubmit="fn_search(); return false;">
<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>"/>
	...
	<div class="search_box" title="<spring:message code='common.searchCondition.msg' />">
		<ul>
			...
			<li>
				...
				<!-- 등록버튼 -->
				<span class="btn_b"><a href="<c:url value='/academy/exam/set/Regist.do' />"  title="<spring:message code='button.create' /> <spring:message code='input.button' />"><spring:message code="button.create" /></a></span> 
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<th class="board_th_link"><spring:message code="exam.set.setId" /></th><!-- 설문세트 코드 -->
		<th><spring:message code="exam.set.setTitle" /></th><!-- 설문세트명 -->
		<th><spring:message code="exam.set.queCount" /></th><!-- 사용여부 -->
		<th><spring:message code="exam.isUse" /></th><!-- 사용여부 -->
		<th><spring:message code="exam.updDt" /></th><!-- 최종수정일시 -->
	</tr>
	</thead>
	<tbody class="ov">	
	...
	<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
	  <tr>
		...
		<!-- 템플릿 이름 -->
		<td class="lt_text3"><a href="<c:url value='/academy/exam/set/Detail.do'/>?setId=${resultInfo.setId}">${resultInfo.setTitle}</a></td>
		<!-- 설문개수 -->
