...
<ul class="lnb_title">
	<c:forEach var="result" items="${resultList}" varStatus="status">
		...
		<c:if test="${isExm == 'false' && result.gid == '1'}">
			<li>
				<strong class="left_title_strong"><strong class="top_title_strong"><spring:message code="comCmm.exm.title"/></strong></strong><!-- 시험관리 -->
			</li>
			<c:set var="isExm" value="true"/>
		</c:if>
