...
function initlMenuList() {
	...
	document.menuManageVO.cntntsUseAt.value="";
 ...
 ******************************************************** */
 function choiceNodes(nodeNum) {
		...
		document.menuManageVO.cntntsUseAt.value = nodeValues[12];
...
<table>
  ...
  <tr>
   <td style="vertical-align:top">
	...
	<input type="hidden" name="tmp_menuNmVal" value="${result.menuNo}|${result.upperMenuId}|${result.menuNm}|${result.progrmFileNm}|${result.menuNo}|${result.menuOrdr}|${result.menuNm}|${result.upperMenuId}|${result.menuDc}|${result.relateImagePath}|${result.relateImageNm}|${result.progrmFileNm}|${result.cntntsUseAt}|${result.chkURL}|">
	</c:forEach>
   ...
   <td style="vertical-align:top">
		...
		<table class="wTable" >
		  ...
		  <tr>
			...
			<!-- 사용여부 -->
			<tr>
				<th><spring:message code="comSymMnuMpm.menuList.cntntsUseAt"/> <span class="pilsu">*</span></th>
				<td class="left">
					<select name="cntntsUseAt" title="${title} ${inputTxt }" cssClass="txt">
						<option value="Y" label="${inputYes}"/>
						<option value="N" label="${inputNo}"/>
					</select>
				</td>
			</tr>
		  <tr>
