...
function fn_save(){
	...
	if(confirm("<spring:message code='common.save.msg' />")){
		varFrom.action =  "<c:url value='/academy/leture/subject/Update.do' />";
		varFrom.submit();
	}
}
</script>
...
<h2>${pageTitle} <spring:message code="title.update" /></h2>
	...
	<tbody >
		...
		<tr>
			...
			<td class="left"><input name="subjectCd" type="text" value="${LectureVO.subjectCd}" style="width:90%;" readonly="true"></td>
		</tr>
		...
		<tr>
			<th>${title}<span class="pilsu">*</span></th>
			<td class="left" colspan="3"><input name="subjectNm" type="text" value="${LectureVO.subjectNm}" style="width:90%;"></td>
		</tr>
		<!-- 사용여부 -->
