...
function fn_save(form){
	...
	form.action = "<c:url value='/academy/survey/mst/Insert.do'/>";
...
<div class="wTableFrm">
<!-- 상단타이틀 -->
<form:form commandName="surveyVO" name="surveyVO" action="" method="post" onSubmit="fn_save(document.forms[0]); return false;">
		...
		<tr>
			...
			<td class="left">
  				<table border="0" cellspacing="0" cellpadding="0" align="center">
					...
					<tr>
						<td height="10"><input type="radio" name="setId" value="${resultList.setId}">${resultList.setTitle}</td>
					</tr>
					</c:forEach>
				</table>
			</td>
