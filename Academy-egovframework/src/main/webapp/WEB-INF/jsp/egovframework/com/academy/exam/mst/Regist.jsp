...
function fn_Insert(form) {
	...
	form.action = "<c:url value='/academy/exam/mst/Insert.do'/>";
...
<form:form commandName="ExamVO" method="post" action="${pageContext.request.contextPath}/academy/exam/mst/Insert.do' />" onSubmit="fn_Insert(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/academy/exam/mst/List.do'/>"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
