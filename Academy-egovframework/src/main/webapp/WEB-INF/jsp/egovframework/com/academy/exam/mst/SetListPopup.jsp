...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/academy/exam/set/SetListPopup.do'/>";
...
function fn_search(){
	...
	vFrom.action = "<c:url value='/academy/exam/set/SetListPopup.do' />";
	vFrom.submit();
}
/* ********************************************************
 * 선택 처리 함수
 ******************************************************** */
function fn_select(setId, setNm){
	...
	opener.setId.value = setId;
	opener.setTitle.value = setNm;
...
<form name="ListForm" action="" method="post" onSubmit="fn_search(); return false;">
	...
	<div class="search_box" title="<spring:message code='common.searchCondition.msg' />">
		<ul>
			...
			<li>
				...
				<input type="submit" class="btn_style3" value="<spring:message code='button.inquire' />" title="<spring:message code='title.inquire' /> <spring:message code='input.button' />" onclick="fn_search(); return false;" />
				<!-- 등록버튼 -->
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<th><spring:message code="exam.set.setId" /></th><!-- 질문유형 -->
		<th class="board_th_link"><spring:message code="exam.set.setTitle" /></th><!-- 문제제목 -->
	</tr>
	</thead>
	<tbody class="ov">	
	...
	<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
	  <tr>
		...
		<!-- 질문내용  -->
		<td class="lt_text3"><a href="javascript:fn_select('${resultInfo.setId}', '${resultInfo.setTitle}')"><c:out value="${resultInfo.setId}"/></a></td>
		<td class="lt_text3L"><a href="javascript:fn_select('${resultInfo.setId}', '${resultInfo.setTitle}')"><c:out value='${resultInfo.setTitle}'/></a></td>
      </tr>
	</c:forEach>	
	</tbody>
	</table>
